...
const model = defineModel<Api.Site.SiteDeductionSearchParams>('model', { required: true });
...
<template>
  <NCard :bordered="false" size="small" class="card-wrapper">
    <NCollapse>
      <NCollapseItem :title="$t('common.search')" name="site-deduction-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="100">
          <NGrid responsive="screen" item-responsive>
            ...
            <NFormItemGi
              span="24 s:12 m:6"
              :label="$t('page.site.deduction.deductionStatus')"
              path="deductionStatus"
              class="pr-24px"
            >
