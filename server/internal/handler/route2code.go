...
var RoutesCodesMap = map[string]string{
	...
	"POST:/api/v1/manage/addSite":             "v1:manage:site:add",
	"POST:/api/v1/manage/deductionSite":       "v1:manage:site:deduction",
	"POST:/api/v1/manage/deleteSite":          "v1:manage:site:delete",
	"POST:/api/v1/manage/editSite":            "v1:manage:site:edit",
	"GET:/api/v1/manage/getAllSites":          "v1:manage:site:getAll",
	"GET:/api/v1/manage/getSiteList":          "v1:manage:site:list",
	"POST:/api/v1/manage/syncRemoteSiteScore": "v1:manage:site:syncRemoteScore",
	"POST:/api/v1/manage/topupSite":           "v1:manage:site:topup",
	"POST:/api/v1/manage/addSiteDeduction":    "v1:manage:site_deduction:add",
	"GET:/api/v1/manage/getSiteDeductionList": "v1:manage:site_deduction:list",
	"POST:/api/v1/manage/addSiteTopup":        "v1:manage:site_topup:add",
	"GET:/api/v1/manage/getSiteTopupList":     "v1:manage:site_topup:list",
